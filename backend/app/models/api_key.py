...
class APIKey(Base):
    ...
    rate_limit_per_hour: Mapped[int | None] = mapped_column(default=1000)  # Requests per hour
...
class APIKeyUsage(Base):
    ...
    request_size_bytes: Mapped[int | None] = mapped_column(default=0)
    response_size_bytes: Mapped[int | None] = mapped_column(default=0)
