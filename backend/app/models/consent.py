...
class ConsentRequest(Base):
    ...
    expires_in_hours: Mapped[Optional[int]] = mapped_column(Integer, default=24)
...
class AccessPolicy(Base):
    ...
    max_usage_per_hour: Mapped[Optional[int]] = mapped_column(Integer)
    max_usage_per_day: Mapped[Optional[int]] = mapped_column(Integer)
