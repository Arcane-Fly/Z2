...
class QuantumTask(Base):
    ...
    # Results
    collapsed_result: Mapped[dict | None] = mapped_column(UniversalJSON)
    final_metrics: Mapped[dict | None] = mapped_column(UniversalJSON)
    execution_summary: Mapped[dict | None] = mapped_column(UniversalJSON)

    # Metadata
    started_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    completed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    total_execution_time: Mapped[float | None] = mapped_column(Float)
...
class Variation(Base):
    ...
    provider: Mapped[str | None] = mapped_column(String(50))  # LLM provider
    model: Mapped[str | None] = mapped_column(String(100))  # Specific model
...
class QuantumThreadResult(Base):
    ...
    # Results
    result: Mapped[dict | None] = mapped_column(UniversalJSON)
