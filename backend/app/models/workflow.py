...
class Workflow(Base):
    ...
    execution_policy: Mapped[Dict] = mapped_column(JSONB, default=dict)  # Routing and execution rules
    ...
    status: Mapped[str] = mapped_column(
        String(20), default="draft"  # "draft", "running", "paused", "completed", "failed"
    )
